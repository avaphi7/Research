//Exercise involving transverse momenta and creating histograms.
...
void CalculateHT() {
    ...
    TH1D *h_HTCentral = new TH1D("h_HTCentral", "HT Central", 100, 0, 1000);
	...
	HTCentral = 0;
	  ...
	  //	  cout << (*jet_pt)[j]/1000. << endl;
		...
		HTCentral += (*jet_pt)[j]/1000.;
		}
        }

        // Fill the histogram with the calculated HT value
        h_HT->Fill(HT);
	h_HTCentral->Fill(HTCentral);
    ...
    TCanvas *c2 = new TCanvas("c2", "HTCentral Plot", 800, 600);
    h_HTCentral->Draw();
    // Save the plot to a file
    c1->SaveAs("HT_plot.png");
    c2->SaveAs("HTCentral_plot.png");
}
